...
<?php 
 session_start();
  ...
  $i=0;
   ...
   $result=mysql_query("SELECT * FROM stories where story LIKE '%$find%' or title LIKE '%$find%' or topic LIKE '%$find%' or writer LIKE '%$find%' ");
				      ...
				      <div class="search-box">
							<div id="sb-search" class="sb-search">
								<form action="search.php" method="post">
									<input class="sb-search-input" placeholder="Search Notes by title ..." type="search" name="find" id="search">
